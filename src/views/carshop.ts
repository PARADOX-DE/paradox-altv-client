...
export class CarshopView extends Window {
    previewCam: number;
    ...
    async PreviewVehicle(vehicleModel: string) {
        if(this.savedPosition.x == 0 && this.savedPosition.y == 0 && this.savedPosition.z == 0) this.savedPosition = alt.Player.local.pos;
