...
class CutsceneController extends Controller {
    ...
    constructor() {
        ...
        EventController.onServer("StartArrivalCutscene", this.start.bind(this));
        EventController.onServer("StopArrivalCutscene", this.stop.bind(this));
...
export default new CutsceneController();